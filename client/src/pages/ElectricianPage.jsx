...
const ElectricianPage = () => {
    ...
    const problems = [
        'Don\'t display credentials prominently',
        'Look unprofessional or outdated',
        'Make it hard to request quotes',
    ...
    const included = [
        ...
        'Credentials and license display',
    ...
    const processSteps = [
        {
            ...
            description: 'We analyze your current site and identify what\'s preventing service calls.',
        },
        {
            step: 'Step 2',
            title: 'Build or fix',
            description: 'We create a professional site that builds trust and showcases your expertise.',
        },
        {
            step: 'Step 3',
        ...
        },
        {
            ...
            description: 'Your site is live and generating qualified leads for electrical work.',
        },
    ];

    const qualifications = [
        'Offer electrical services',
        'Want more service calls and quotes',
            ...
            <section className="section section-dark" style={{
                ...
                <div className="container" style={{ maxWidth: '800px' }}>
                    <h1 className="animate-fade-in-down" style={{
                        ...
                        Electrician websites that get <span className="text-gradient-primary">service calls</span>
                    </h1>
                    <p className="animate-fade-in-up delay-200" style={{
                        ...
                        Built for UK electricians who want to build trust instantly and win more jobs.
                    </p>
                    <div className="animate-fade-in-up delay-400">
                        <a
                            href="https://wa.me/919811674377?text=Hi!%20I'd%20like%20a%20free%20electrician%20website%20review"
                            target="_blank"
                        ...
                        >
                            📞 Get a free electrician website review
                        </a>
                    </div>
                    <p style={{
                        marginTop: '1.5rem',
                        ...
                        No contracts · Professional design · Built for trust
                    </p>
                </div>
            </section>
                ...
                <div className="container" style={{ maxWidth: '900px' }}>
                    <div className="text-center" style={{ marginBottom: '3rem' }}>
                        <h2 className={isVisible(problemVisible) ? 'animate-fade-in-up' : ''}>
                            Homeowners want to hire <span className="text-gradient-primary">licensed, trustworthy electricians</span>
                        </h2>
                    </div>
                    ...
                    <div className={`card ${isVisible(problemVisible) ? 'animate-fade-in-up' : ''}`} style={{
                        ...
                        <p style={{ marginBottom: '1.5rem' }}>
                            <strong>Electrical work is serious business.</strong><br />
                            Customers need to trust you're qualified, licensed, and professional before they call.
                        </p>
                        ...
                        <ul style={{
                            ...
                            <li style={{ marginBottom: '0.5rem' }}>❌ doesn't show your credentials</li>
                            <li style={{ marginBottom: '0.5rem' }}>❌ looks unprofessional</li>
                            <li style={{ marginBottom: '0.5rem' }}>❌ makes quoting difficult</li>
                            <li style={{ marginBottom: '0.5rem' }}>❌ doesn't build trust</li>
                        </ul>
                        ...
                        <p style={{
                            ...
                            they'll call a more professional-looking competitor.
                        </p>
                ...
                <div className="container" style={{ maxWidth: '900px' }}>
                    ...
                    <div className="card" style={{
                        ...
                        <h3 style={{ marginBottom: '1.5rem', color: 'var(--primary)' }}>
                            Most electrician websites fail because they:
                        </h3>
                        <ul style={{
                            listStyle: 'none',
                            fontSize: '1.1rem',
                        ...
                        <p style={{
                            ...
                            In electrical work, trust and credentials win jobs.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container" style={{ maxWidth: '900px' }}>
                    <div className="text-center" style={{ marginBottom: '3rem' }}>
                        <h2 className={isVisible(solutionVisible) ? 'animate-fade-in-up' : ''}>
                            Websites designed specifically for <span className="text-gradient-primary">electricians</span>
                        </h2>
                    </div>
                    ...
                    <div className={`card ${isVisible(solutionVisible) ? 'animate-fade-in-up' : ''}`} style={{
                        ...
                        <p style={{ marginBottom: '1.5rem', fontSize: '1.15rem' }}>
                            We build professional websites with one goal:
                        </p>
                        <p style={{
                            fontSize: '1.3rem',
                            fontWeight: 'bold',
                            ...
                            building trust instantly and generating qualified service calls.
                        </p>
                        ...
                        <div style={{
                            ...
                            <p>No hidden credentials.</p>
                            <p>No amateur design.</p>
                        </div>

                        <p style={{ fontSize: '1.15rem', fontWeight: '600' }}>
                            Just a professional site that proves you're the right electrician for the job.
                        </p>
                    </div>
                    ...
                    <div className={`card ${isVisible(solutionVisible) ? 'animate-fade-in-up' : ''}`} style={{
                        ...
                        <p style={{
                            ...
                            Everything designed to build trust and win electrical jobs.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container" style={{ maxWidth: '800px' }}>
                    ...
                    <div className={`card ${isVisible(qualifyVisible) ? 'animate-fade-in-up' : ''}`} style={{
                        ...
                        <p style={{
                            ...
                            If you're not an electrician, this page isn't for you — and that's intentional.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="section section-light" style={{
                ...
                <div className="container" style={{ maxWidth: '700px' }}>
                    <h2 style={{
                        ...
                        Find out what's costing you <span className="text-gradient-primary">service calls</span>
                    </h2>
                    <a
                        href="https://wa.me/919811674377?text=Hi!%20I'd%20like%20a%20free%20electrician%20website%20review"
                        target="_blank"
            ...
            <section className="section section-dark" style={{
                ...
                <div className="container">
                    <p style={{
                        ...
                        Electrician websites built for the UK<br />
